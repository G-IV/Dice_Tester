...
class Annotator(ABC):
    ...
    def annotate_frame(self):
        """Abstract method to annotate the frame with detected dice and their values."""
        pass
    ...
    def annotate_die(self):
        ...
        # Placeholder for annotation logic, which would use self.data.analysis results to draw bounding boxes and labels on self.data.frame
        pass
